...
### Add mount points
```
mkdir "/mnt/pool-1/iocage/jails/jail_name/root/Plex Media Server"
iocage fstab -a jail_name /mnt/pool-1/apps/plexmediaserver "/Plex Media Server" nullfs rw 0 0
